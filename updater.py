...
Supplies RTF_to_PDF_Converter's repo/app name/version and the zero-arg
call shape rtf_to_pdf_converter.py uses. See kvg_updater's README for
the full package.
"""
...
GITHUB_REPO = "gerp93/KVG_Converter"
